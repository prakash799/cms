...
<body>
	...
	<div id="dialog-1" title="Update User Details"
		style="display: none; border: solid sliver 1px; background-color: white;">
		<form:form action="udpateuserdetails" class="form-horizontal"
